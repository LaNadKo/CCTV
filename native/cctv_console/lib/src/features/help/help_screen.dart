        ...
        builder: (context, constraints) {
          ...
          final search = TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: 'Live, ONVIF, отчёты, Processor, 2FA...',
...
const _helpTabs = [
  _HelpTab(
    ...
    label: 'Общее',
    description:
        'Вход в систему, 2FA, настройки клиента, профиль пользователя и принципы работы Console.',
    sections: [
      _HelpSection(
        id: 'start',
        title: 'Быстрый старт',
      ...
      _HelpSection(
        ...
        title: 'Настройки',
        summary:
            'В настройках меняются backend URL, акцентные цвета, плотность Live и состав верхнего меню.',
        bullets: [
          ...
          'Сброс оформления возвращает стандартные цвета, плотность Live и порядок меню; тема переключается отдельной кнопкой в шапке.',
        ],
        previewTitle: 'Что видно на экране',
        previewLines: [
          'Backend URL и кнопка сохранения',
          'Акцентные цвета и плотность Live',
    ...
    sections: [
      ...
      _HelpSection(
        ...
        bullets: [
          ...
          'Если обычный плеер не открыл файл, используйте MJPEG fallback или кнопку открытия файла.',
        ],
        previewTitle: 'Что видно на экране',
        previewLines: [
          'Суточный медиаплеер',
          'Папки часов и карточки минутных клипов',
          'Метки событий, download/open и MJPEG fallback',
        ],
      ...
      _HelpSection(
        ...
        bullets: [
          'Карточка события показывает snapshot, камеру, время, confidence и связанную запись.',
          'Перед подтверждением можно выбрать существующую персону, чтобы review записал person_id.',
          'Из snapshot или recording можно создать новую персону и сразу привязать её к событию.',
        ],
        previewTitle: 'Что видно на экране',
        previewLines: [
      ...
      _HelpSection(
        ...
        bullets: [
          'Фильтры по датам, группам, камерам, Processor, пользователям и персонам применяются к экрану и экспорту.',
          'На экране есть детальные таблицы камер, групп, Processor, архива, безопасности, ревьюеров и появлений персон.',
          'Экспорт PDF, Excel и Word формируется backend-ом по текущему разделу и активным фильтрам.',
        ],
        previewTitle: 'Что видно на экране',
        previewLines: [
    ...
    sections: [
      _HelpSection(
        ...
        bullets: [
          ...
          'Эмбеддинг можно добавить из файла или из текущего Live-кадра выбранной камеры.',
          'Новую персону можно создать вручную или сразу из фотографии с извлечением лица на backend.',
        ],
        previewTitle: 'Что видно на экране',
        previewLines: [
          'Список персон с ФИО',
          'Эмбеддинги, Live-кадр и история появлений',
    ...
    sections: [
      ...
      _HelpSection(
        ...
        bullets: [
          ...
          'Scopes, описание, активность и срок действия можно редактировать после создания.',
