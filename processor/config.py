...
class Settings(BaseSettings):
    ...
    track_observation_enabled: bool = Field(default=True, validation_alias="TRACK_OBSERVATION_ENABLED")
    track_observation_interval: float = Field(default=0.2, validation_alias="TRACK_OBSERVATION_INTERVAL")
    track_observation_include_unknown: bool = Field(default=True, validation_alias="TRACK_OBSERVATION_INCLUDE_UNKNOWN")
