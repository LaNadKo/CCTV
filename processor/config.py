...
class Settings(BaseSettings):
    ...
    face_scan_interval: int = Field(default=2, validation_alias="FACE_SCAN_INTERVAL")
    face_match_threshold: float = Field(default=0.58, validation_alias="FACE_MATCH_THRESHOLD")
    face_match_margin: float = Field(default=0.12, validation_alias="FACE_MATCH_MARGIN")
    antispoof_small_face_ratio: float = Field(default=0.03, validation_alias="ANTISPOOF_SMALL_FACE_RATIO")
    antispoof_face_motion_threshold: float = Field(default=9.0, validation_alias="ANTISPOOF_FACE_MOTION_THRESHOLD")
    antispoof_context_motion_threshold: float = Field(default=5.5, validation_alias="ANTISPOOF_CONTEXT_MOTION_THRESHOLD")
